#!/usr/bin/env python3
"""
Passenger Inflight Purchase Data Generator

This script generates nested JSON files containing passenger inflight purchase information
for the year 2025. The data includes 8 main keys with nested structures suitable for
BigQuery JSON processing.
...
def generate_flight_info() -> Dict[str, Any]:
...
def generate_personal_info() -> Dict[str, Any]:
...
def generate_loyalty_status() -> Dict[str, Any]:
...
def generate_payment_methods() -> List[Dict[str, Any]]:
...
def generate_passenger_record() -> Dict[str, Any]:
...
def main():
    ...
    airline_counts = {}
    for record in file1_records + file2_records:
        airline = record['flight_info']['airline']
    ...
    tier_counts = {}
    for record in file1_records + file2_records:
        tier = record['loyalty_status']['tier']
